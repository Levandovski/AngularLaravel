...
/***/ "./src/app/post-dialog/post-dialog.component.sass":
/*!********************************************************!*\
  !*** ./src/app/post-dialog/post-dialog.component.sass ***!
  \********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Bvc3QtZGlhbG9nL3Bvc3QtZGlhbG9nLmNvbXBvbmVudC5zYXNzIn0= */"
...
var PostDialogComponent = /** @class */ (function () {
    ...
    PostDialogComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./post-dialog.component.sass */ "./src/app/post-dialog/post-dialog.component.sass")]
        }),
...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.salvar = function (post, file) {
        ...
        this.http.post("/api", uploadData, { reportProgress: true, observe: 'events' })
            ...
            if (event.type == _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpEventType"].Response) { //Estamos recebendo nosso response lá do laravel após inserir o dado na base de dados
                //console.log(event);
                var p = event.body;
                _this.posts.push(new _post__WEBPACK_IMPORTED_MODULE_2__["Post"](p.nome, p.titulo, p.subtitulo, p.email, p.mensagem, p.arquivo, p.id, p.likes));
            }
    ...
    PostService.prototype.apagar = function (id) {
        ...
        this.http.delete('/api/' + id).subscribe(function (event) {
            ...
            if (i >= 0) { //se retornar -1 é porque não econtrou nada
                _this.posts.splice(i, 1); //significa que vamos retirar isso do nosso post
            }
        });
    };
...
module.exports = __webpack_require__(/*! /home/laravel/lar_angular/resources/meuapp/src/main.ts */"./src/main.ts");
